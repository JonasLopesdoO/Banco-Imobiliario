...
public class TerrenoItemBox3 extends Terreno{
	public TerrenoItemBox3(){
		Localizacao localizacao = new Localizacao(710,240);  
	...
	public void efeito(Jogador jogador) {
		...
		ArrayList<SorteOuRevez> listaSR = ControladorSorteOuRevez.getInstance().getSorteOuReves();		int x = random.nextInt(listaSR.size());
